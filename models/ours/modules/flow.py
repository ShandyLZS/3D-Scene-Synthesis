...
def build_latent_flow(cfg):
    chain = []
    for i in range(cfg.config.model_param.latent_flow_depth):
        chain.append(CouplingLayer(cfg.config.data.z_dim, cfg.config.model_param.latent_flow_hidden_dim, swap=(i % 2 == 0)))
